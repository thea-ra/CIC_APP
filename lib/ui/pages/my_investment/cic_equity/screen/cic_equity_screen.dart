...
class _EquityScreenState extends State<EquityScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final dashboard = Get.put(IncomeController());
    var MONTHS = [
      "Jan",
      "Feb",
      "Mar",
    ...
    return Column(
      children: [
        Expanded(
          child: Obx(
            () => dashboard.isloadingFetchIncome.value
                ? const Center(
                          ...
                          child: Stack(
                            children: [
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    const Padding(
                                      padding:
                                          EdgeInsets.only(left: 14, top: 20),
                                      child: IconText(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          TotalUT(
                                            title: 'Total UT',
                                            subtile:
                                                '${dashboard.totalprice.value.totalshareoutstanding}',
                                          ...
                                          TotalUT(
                                            ...
                                            subtile:
                                                '\$ ${dashboard.totalprice.value.totalnetworth}',
                                    ...
                                    const Padding(
                                      padding:
                                          EdgeInsets.only(left: 14, top: 38),
                                      child: Titlesub(
                              ...
                              Padding(
                                ...
                                child: Center(
                                    child:
                                        SvgPicture.asset('asset/svg/line.svg')),
                              )
                            ],
                          ),
                        ),
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.symmetric(
                                            vertical: 3),
                                        child: Text(
                                            getcon.infos[getcon.index.value]
                                                    .info!.total ??
                                                "",
